...
import { verifyEmailCode } from "../services/registerService";

export default function ConfirmEmail({ onClose, email, emailVerificationKey }) {
  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center bg-gray-800 bg-opacity-75 z-50">
      <div className="bg-white p-8 rounded-2xl shadow-lg w-full max-w-2xl text-right rtl space-y-8">
        ...
        <p className="mb-4">{email} ادخل الرمز الذي ارسلناه للتو الى</p>
        <input
          type="text"
